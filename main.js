...
app.whenReady().then(async () => {
  ...
  // Also expose simplified names as requested by user
  wrapHandler('getSetting', (key) => dbHandler.getSetting(key));
  wrapHandler('setSetting', (key, value) => dbHandler.setSetting(key, value));
